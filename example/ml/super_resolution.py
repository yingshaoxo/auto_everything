...
#edge_line = image_transformer.get_edge_lines_of_a_image_by_using_yingshaoxo_method(no_hd_image, min_color_distance=20, smooth_value=3)
#edge_line.save_image_to_file_path("/home/yingshaoxo/Downloads/edge.png")

#no_hd_image = image_transformer.scale_up_animation_by_using_yingshaoxo_method(no_hd_image)
