...
audio_1_hash = audio_1.to_hash(hash_length=6)
audio_2_hash = audio_2.to_hash(hash_length=6)
audio_3_hash = audio_3.to_hash(hash_length=6)
audio_4_hash = audio_4.to_hash(hash_length=6)
