...
MOD_INIT_DECL( auto_everything$base );
MOD_INIT_DECL( auto_everything$video );
MOD_INIT_DECL( auto_everything$web );
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    { "auto_everything", MOD_INIT_NAME( auto_everything ), 0, 0, NUITKA_PACKAGE_FLAG },
    { "auto_everything.base", MOD_INIT_NAME( auto_everything$base ), 0, 0, NUITKA_COMPILED_MODULE },
    { "auto_everything.video", MOD_INIT_NAME( auto_everything$video ), 0, 0, NUITKA_COMPILED_MODULE },
    { "auto_everything.web", MOD_INIT_NAME( auto_everything$web ), 0, 0, NUITKA_COMPILED_MODULE },
    { NULL, NULL, 0, 0, 0 }
};
