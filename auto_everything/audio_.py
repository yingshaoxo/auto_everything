...
A general sound file is end up with ".wav". Sound inside is saved as a sine wave. But it is a perfect sine wave.
Sometimes, if the sound volumn go up, the absolute height of the signal goes up, if the sound volumn go down, the absolute height of the signal goes down. When you meet silence of a sound, you will see a stright horizontal line in 0dB.
